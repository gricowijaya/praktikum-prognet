...
<html lang="en">
  <head>
	...
	<link rel="stylesheet" href="{{asset('style/login-templates/css/style.css')}}">
			...
			<div class="row justify-content-center">
				<div class="col-md-12 col-lg-10">
					<div class="wrap d-md-flex">
						<div class="img" style="background-image: url({{asset('style/login-templates/images/bg-1.jpg')}});">
			      </div>
