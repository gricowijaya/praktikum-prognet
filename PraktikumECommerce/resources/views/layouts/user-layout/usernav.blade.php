<div class="container-fluid">
        <div class="row border-top px-xl-5">
            <div class="col-lg-3 d-none d-lg-block bg-shopee">
            ...
            <div class="col-lg-9">
                <nav class="navbar navbar-expand-lg bg-light navbar-light py-3 py-lg-0 px-0">
                    ...
                    <div class="collapse navbar-collapse justify-content-between bg-shopee" id="navbarCollapse">
                        ...
                        @guest
                            ...
                            @if (Route::has('register'))                                                    
                                    <a href="{{ route('register') }}" class="nav-item nav-link text-white">{{ __('Register') }}</a>
                                </div>
                            @endif
                        @else
                            <div class="navbar-nav ml-auto py-0">
                                <a href="/profile" class="nav-item nav-link text-white">{{auth()->user()->name}}</a>                              
